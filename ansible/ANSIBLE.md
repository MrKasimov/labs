...
```
user@mrkasimov ansible % ansible-playbook -i inventory/inventory.yaml playbooks/main.yaml --diff
...
```
user@mrkasimov ansible % ansible-inventory -i inventory/inventory.yaml --list
